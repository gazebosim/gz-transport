...
Download the `publisher.cc <https://github.com/ignitionrobotics/ign-transport/raw/ign-transport2/example/publisher.cc>`_ file within the ``ign_transport_tutorial``
...
Download the `subscriber.cc <https://github.com/ignitionrobotics/ign-transport/raw/ign-transport2/example/subscriber.cc>`_ file within the ``ign_transport_tutorial``
folder and open it with your favorite editor:
