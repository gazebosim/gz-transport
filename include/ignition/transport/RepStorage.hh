...
namespace ignition
{
  namespace transport
  {
    ...
    class RepStorage
    {
      ...
      public: void AddRepHandler(const std::string &_topic,
      ...
      public: bool HasRepHandler(const std::string &_topic,
                                 const std::string &_nUuid);
