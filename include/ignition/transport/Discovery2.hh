...
namespace ignition
{
  namespace transport
  {
    ...
    template<typename Pub> class IGNITION_VISIBLE Discovery2
    {
      /// \brief Constructor.
      ...
      public: Discovery2(const std::string &_pUuid,
                         const int _port,
                         const bool _verbose = false)
      {
          ...
          this->port = _port;
          this->pUuid = _pUuid;
          this->silenceInterval = this->DefSilenceInterval;
          this->activityInterval = this->DefActivityInterval;
          this->advertiseInterval = this->DefAdvertiseInterval;
          this->heartbeatInterval = this->DefHeartbeatInterval;
          this->connectionCb = nullptr;
          this->disconnectionCb = nullptr;
      ...
      private: void RecvDiscoveryUpdate()
      {
        ...
        {
          std::cerr << "Discovery2::RecvDiscoveryUpdate() recvfrom error" << std::endl;
          return;
        }
      ...
      private: std::condition_variable_any initializedCv;
