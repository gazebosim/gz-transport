    ...
    dataPtr(new NodeSharedPrivate)
{
  ...
  this->dataPtr->msgDiscovery.reset(new MsgDiscovery(this->pUuid, this->kMsgDiscPort));
  this->dataPtr->srvDiscovery.reset(new SrvDiscovery(this->pUuid, this->kSrvDiscPort));
