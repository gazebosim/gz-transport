...
cmake -DZeroMQ_ROOT_DIR="..\..\ZeroMQ 3.2.4" -DPROTOBUF_SRC_ROOT_FOLDER="..\..\..\protobuf-2.6.0-win%build_bitness%-vc12" -DCPPZMQ_HEADER_PATH="..\..\cppzmq" -DCMAKE_INSTALL_PREFIX="install" -DCMAKE_PREFIX_PATH="..\build\install\%build_type%\lib\cmake\ignition-transport" -G "NMake Makefiles" -DCMAKE_BUILD_TYPE=%build_type% .. 
